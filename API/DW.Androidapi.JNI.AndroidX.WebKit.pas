...
type
  JBackForwardCacheSettings = interface;
  JBackForwardCacheSettings_Builder = interface;
  JCookieManagerCompat = interface;
  JCustomHeader = interface;
  JDropDataContentProvider = interface;
  JJavaScriptReplyProxy = interface;
  JNavigation = interface;
  JNavigationListener = interface;
  JNoVarySearchHeader = interface;
  JOutcomeReceiverCompat = interface;
  JPage = interface;
  JPrefetchException = interface;
  JPrefetchNetworkException = interface;
  JPrerenderException = interface;
  JPrerenderOperationCallback = interface;
  JProcessGlobalConfig = interface;
  JProcessGlobalConfig_UiThreadStartupMode = interface;
  JProfile = interface;
  JProfile_ExperimentalAddQuicHints = interface;
  JProfile_ExperimentalOriginMatchedHeader = interface;
  JProfile_ExperimentalPreconnect = interface;
  JProfile_ExperimentalUrlPrefetch = interface;
  JProfile_ExperimentalWarmUpRendererProcess = interface;
  JProfileStore = interface;
  JProxyConfig = interface;
  JProxyConfig_Builder = interface;
  JProxyConfig_ProxyRule = interface;
  JProxyConfig_ProxyScheme = interface;
  JProxyController = interface;
  JRestrictionAllowlist = interface;
  JRestrictionAllowlist_Builder = interface;
  JSafeBrowsingResponseCompat = interface;
  JScriptHandler = interface;
  JServiceWorkerClientCompat = interface;
  JServiceWorkerControllerCompat = interface;
  JServiceWorkerWebSettingsCompat = interface;
  JServiceWorkerWebSettingsCompat_CacheMode = interface;
  JSpeculativeLoadingConfig = interface;
  JSpeculativeLoadingConfig_Builder = interface;
  JSpeculativeLoadingParameters = interface;
  JSpeculativeLoadingParameters_Builder = interface;
  JStartUpLocation = interface;
  Jwebkit_TracingConfig = interface;
  Jwebkit_TracingConfig_Builder = interface;
  JTracingConfig_PredefinedCategories = interface;
  JTracingConfig_TracingMode = interface;
  Jwebkit_TracingController = interface;
  JURLUtilCompat = interface;
  JUserAgentMetadata = interface;
  JUserAgentMetadata_BrandVersion = interface;
  JBrandVersion_Builder = interface;
  JUserAgentMetadata_Builder = interface;
  JUserAgentMetadata_FormFactors = interface;
  JWebMessageCompat = interface;
  JWebMessageCompat_Type = interface;
  JWebMessagePortCompat = interface;
  JWebMessagePortCompat_WebMessageCallbackCompat = interface;
  JWebNavigationClient = interface;
  JWebNavigationClient_ExperimentalNavigationCallback = interface;
  JWebResourceErrorCompat = interface;
  JWebResourceErrorCompat_NetErrorCode = interface;
  JWebResourceRequestCompat = interface;
  JWebResourceResponseCompat = interface;
  JWebSettingsCompat = interface;
  JWebSettingsCompat_ExperimentalBackForwardCacheSettings = interface;
  JWebSettingsCompat_ExperimentalSpeculativeLoading = interface;
  JWebSettingsCompat_ForceDark = interface;
  JWebSettingsCompat_ForceDarkStrategy = interface;
  JWebSettingsCompat_HyperlinkContextMenuItems = interface;
  JWebSettingsCompat_MenuItemFlags = interface;
  JWebStorageCompat = interface;
  JWebViewAssetLoader = interface;
  JWebViewAssetLoader_AssetsPathHandler = interface;
  JWebViewAssetLoader_Builder = interface;
  JWebViewAssetLoader_InternalStoragePathHandler = interface;
  JWebViewAssetLoader_PathHandler = interface;
  JWebViewAssetLoader_ResourcesPathHandler = interface;
  JWebViewBuilder = interface;
  JWebViewBuilder_Experimental = interface;
  JWebViewBuilder_Preset = interface;
  JWebViewBuilderException = interface;
  JWebViewClientCompat = interface;
  JWebViewClientCompat_SafeBrowsingThreat = interface;
  JWebViewCompat = interface;
  JWebViewCompat_ExperimentalAsyncStartUp = interface;
  JWebViewCompat_ExperimentalSaveState = interface;
  JWebViewCompat_VisualStateCallback = interface;
  JWebViewCompat_WebMessageListener = interface;
  JWebViewCompat_WebViewStartUpCallback = interface;
  JWebViewFeature = interface;
  JWebViewFeature_WebViewStartupFeature = interface;
  JWebViewFeature_WebViewSupportFeature = interface;
  JWebViewMediaIntegrityApiStatusConfig = interface;
  JWebViewMediaIntegrityApiStatusConfig_Builder = interface;
  Jwebkit_WebViewRenderProcess = interface;
  Jwebkit_WebViewRenderProcessClient = interface;
  JWebViewStartUpConfig = interface;
  JWebViewStartUpConfig_Builder = interface;
  JWebViewStartUpResult = interface;
  JApiFeature = interface;
  JApiFeature_M = interface;
  JApiFeature_N = interface;
  JApiFeature_NoFramework = interface;
  JApiFeature_O = interface;
  JApiFeature_O_MR1 = interface;
  JApiFeature_P = interface;
  JApiFeature_Q = interface;
  JApiFeature_T = interface;
  JApiHelperForN = interface;
  JApiHelperForO = interface;
  JApiHelperForOMR1 = interface;
  JApiHelperForP = interface;
  JApiHelperForQ = interface;
  JApiHelperForTiramisu = interface;
  JAssetHelper = interface;
  JBackForwardCacheSettingsImpl = interface;
  JConditionallySupportedFeature = interface;
  JCookieManagerAdapter = interface;
  JFrameworkServiceWorkerClient = interface;
  JIncompatibleApkWebViewProviderFactory = interface;
  JJavaScriptReplyProxyImpl = interface;
  JNavigationImpl = interface;
  JNavigationListenerAdapter = interface;
  JNoVarySearchHeaderAdapter = interface;
  JPageImpl = interface;
  JPrefetchOperationCallbackAdapter = interface;
  JProfileImpl = interface;
  JProfileStoreImpl = interface;
  JProxyControllerImpl = interface;
  JSafeBrowsingResponseImpl = interface;
  JScriptHandlerImpl = interface;
  JServiceWorkerClientAdapter = interface;
  JServiceWorkerControllerImpl = interface;
  JServiceWorkerWebSettingsImpl = interface;
  JSpeculativeLoadingConfigAdapter = interface;
  JSpeculativeLoadingParametersAdapter = interface;
  JStartupApiFeature = interface;
  JStartupApiFeature_NoFramework = interface;
  JStartupApiFeature_P = interface;
  JStartupFeatures = interface;
  JTracingControllerImpl = interface;
  JUserAgentMetadataInternal = interface;
  JVisualStateCallbackAdapter = interface;
  JWebMessageAdapter = interface;
  JWebMessageCallbackAdapter = interface;
  JWebMessageListenerAdapter = interface;
  JWebMessagePayloadAdapter = interface;
  JWebMessagePortImpl = interface;
  JWebNavigationClientAdapter = interface;
  JWebResourceErrorImpl = interface;
  JWebResourceRequestAdapter = interface;
  JWebSettingsAdapter = interface;
  JWebSettingsNoOpAdapter = interface;
  JWebStorageAdapter = interface;
  JWebViewFeatureInternal = interface;
  JWebViewGlueCommunicator = interface;
  JWebViewProviderAdapter = interface;
  JWebViewProviderFactory = interface;
  JWebViewProviderFactoryAdapter = interface;
  JWebViewRenderProcessClientAdapter = interface;
  JWebViewRenderProcessClientFrameworkAdapter = interface;
  JWebViewRenderProcessImpl = interface;
  JWebViewStartUpCallbackAdapter = interface;
  JWebViewStartUpConfigAdapter = interface;
  JWebkitToCompatConverter = interface;
  JDropDataContentProviderBoundaryInterface = interface;
  JFeatureFlagHolderBoundaryInterface = interface;
  JIsomorphicObjectBoundaryInterface = interface;
  JJsReplyProxyBoundaryInterface = interface;
  JNoVarySearchDataBoundaryInterface = interface;
  JOriginMatchedHeaderBoundaryInterface = interface;
  JPrefetchOperationCallbackBoundaryInterface = interface;
  JPrefetchOperationCallbackBoundaryInterface_PrefetchExceptionTypeBoundaryInterface = interface;
  JProcessGlobalConfigConstants = interface;
  JProcessGlobalConfigConstants_ProcessGlobalConfigMapKey = interface;
  JProfileBoundaryInterface = interface;
  JProfileStoreBoundaryInterface = interface;
  JProxyControllerBoundaryInterface = interface;
  JSafeBrowsingResponseBoundaryInterface = interface;
  JScriptHandlerBoundaryInterface = interface;
  JServiceWorkerClientBoundaryInterface = interface;
  JServiceWorkerControllerBoundaryInterface = interface;
  JServiceWorkerWebSettingsBoundaryInterface = interface;
  JSpeculativeLoadingConfigBoundaryInterface = interface;
  JSpeculativeLoadingParametersBoundaryInterface = interface;
  JStaticsBoundaryInterface = interface;
  JTracingControllerBoundaryInterface = interface;
  JVisualStateCallbackBoundaryInterface = interface;
  JWebMessageBoundaryInterface = interface;
  JWebMessageCallbackBoundaryInterface = interface;
  JWebMessageListenerBoundaryInterface = interface;
  JWebMessagePayloadBoundaryInterface = interface;
  JWebMessagePayloadBoundaryInterface_WebMessagePayloadType = interface;
  JWebMessagePortBoundaryInterface = interface;
  JWebResourceErrorBoundaryInterface = interface;
  JWebResourceRequestBoundaryInterface = interface;
  JWebSettingsBoundaryInterface = interface;
  JWebSettingsBoundaryInterface_AttributionBehavior = interface;
  JWebSettingsBoundaryInterface_ForceDarkBehavior = interface;
  JWebSettingsBoundaryInterface_HyperlinkContextMenuItems = interface;
  JWebSettingsBoundaryInterface_SpeculativeLoadingStatus = interface;
  JWebSettingsBoundaryInterface_WebViewMediaIntegrityApiStatus = interface;
  JWebSettingsBoundaryInterface_WebauthnSupport = interface;
  JWebStorageBoundaryInterface = interface;
  JWebViewBackForwardCacheSettingsBoundaryInterface = interface;
  JWebViewBuilderBoundaryInterface = interface;
  JWebViewBuilderBoundaryInterface_Baseline = interface;
  JWebViewBuilderBoundaryInterface_Config = interface;
  JWebViewBuilderBoundaryInterface_ConfigField = interface;
  JWebViewClientBoundaryInterface = interface;
  JWebViewCookieManagerBoundaryInterface = interface;
  JWebViewNavigationBoundaryInterface = interface;
  JWebViewNavigationClientBoundaryInterface = interface;
  JWebViewNavigationListenerBoundaryInterface = interface;
  JWebViewPageBoundaryInterface = interface;
  JWebViewProviderBoundaryInterface = interface;
  JWebViewProviderFactoryBoundaryInterface = interface;
  JWebViewRendererBoundaryInterface = interface;
  JWebViewRendererClientBoundaryInterface = interface;
  JWebViewStartUpCallbackBoundaryInterface = interface;
  JWebViewStartUpConfigBoundaryInterface = interface;
  JWebViewStartUpResultBoundaryInterface = interface;
  JWebkitToCompatConverterBoundaryInterface = interface;
  JBoundaryInterfaceReflectionUtil = interface;
  JFeatures = interface;
